...
'''
이 코드는 음악 이론에서 사용되는 키(조성)를 숫자로 표현한 것입니다:

1. `MAJOR_KEY`:
   - 0부터 11까지의 숫자는 12개의 장조를 나타냅니다.
   - 예: 0 = C 장조, 1 = C# 장조, 2 = D 장조, ... 11 = B 장조

2. `MINOR_KEY`:
   - 12부터 23까지의 숫자는 12개의 단조를 나타냅니다.
   - 예: 12 = C 단조, 13 = C# 단조, 14 = D 단조, ... 23 = B 단조

이러한 숫자 표현은 MIDI 파일이나 디지털 음악 처리에서 자주 사용됩니다. 이를 통해:

- 키를 쉽게 식별하고 조작할 수 있습니다.
- 장조와 단조를 명확히 구분할 수 있습니다.
- 키 변경이나 조옮김 같은 작업을 수학적으로 처리할 수 있습니다.

이 표현 방식은 음악 프로그래밍에서 키를 다룰 때 매우 유용하며, 특히 MIDI 파일을 처리하거나 음악 생성 알고리즘을 개발할 때 자주 사용됩니다.
'''
